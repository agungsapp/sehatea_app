								...
								<div class="col-12 col-xl-4">
										<div class="justify-content-end d-flex">
												<div class="dropdown flex-md-grow-1 flex-xl-grow-0">
														<button class="btn btn-sm btn-light dropdown-toggle bg-white" type="button" id="dropdownMenuDate2"
								...
								<div class="col-md-6 stretch-card transparent mb-4">
										<div class="card card-tale">
												<div class="card-body">
														...
														<p class="fs-30 mb-2">{{ $produks->count() }}</p>
														{{-- <p>10.00% (30 days)</p> --}}
												</div>
										</div>
								</div>
								<div class="col-md-6 stretch-card transparent mb-4">
										<div class="card card-dark-blue">
												<div class="card-body">
														...
														<p class="fs-30 mb-2">{{ $bahans->count() }}</p>
														{{-- <p>22.00% (30 days)</p> --}}
												</div>
										</div>
								</div>
						...
						<div class="row">
								...
								<div class="col-md-6 stretch-card transparent">
										<div class="card card-light-danger">
												<div class="card-body">
														<p class="mb-4">Pengeluaran Hari ini</p>
				...
				<div class="col-md-6 grid-margin stretch-card">
						<div class="card">
								<div class="card-body">
										...
										<div id="sales-legend" class="chartjs-legend mb-2 mt-4"></div>
																		...
																		<div class="col-md-12 col-xl-9">
																				<div class="row">
																						<div class="col-md-6 border-right">
																								<div class="table-responsive mb-md-0 mb-3 mt-3">
																										<table class="table-borderless report-table table">
																												<tr>
								...
								<div class="card-body">
										...
										<div class="table-responsive">
												<table class="table-borderless table">
														<thead>
																<tr>
																		<th class="border-bottom pb-2 pl-0">Places</th>
												...
												<div class="card-body">
														...
														<div class="row">
																<div class="col-8 text-white">
																		<h3>34040</h3>
																		<p class="font-weight-500 mb-0 text-white">
																				The total number of sessions within the date
